    ...
    <div className="h-[calc(100vh-4rem)] flex flex-col bg-white dark:bg-[#0D0D0D]">
      ...
      <div className="h-16 shrink-0 flex items-center justify-between px-6 border-b border-zinc-200 dark:border-zinc-800 bg-white/50 dark:bg-white/2 backdrop-blur-sm">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-zinc-500 dark:text-zinc-400">合规检查与风险控制</p>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center px-6">
        <div className="text-center max-w-md">
          <div className="w-16 h-16 rounded-full bg-indigo-50 dark:bg-indigo-500/20 flex items-center justify-center mx-auto mb-6">
          ...
          <button
            onClick={() => router.push("/")}
            className="px-6 py-2.5 bg-indigo-600 hover:bg-indigo-500 text-white text-sm font-medium rounded-lg shadow-sm transition-all duration-200"
          >
            返回首页
          </button>
        </div>
